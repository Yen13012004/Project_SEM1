                        ...
                        <form action="{{ route('admin.blog.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <img style="height: 200px;width:200px !important; cursor: pointer;" class="thumbnail rounded-circle"
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="title" id="name" placeholder="Title" type="text"
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="sub_title" id="name" placeholder="subTitle" type="text"
