...
@section('main')
    ...
    <div class="site-main  main-container no-sidebar">
        <div class="section-037">
            <div class="container">
                <div class="kaycee-popupvideo style-01">
                    <div class="popupvideo-inner">
                        <div class="icon">
                            <img src="assets/images/about-img.jpg" class="attachment-full size-full" alt="img">
                            <div class="product-video-button">
                                <a class="buttonvideo" href="#" data-videosite="vimeo" data-videoid="28605017"
                                    tabindex="0">
            ...
            <div class="container">
                ...
                <div class="kaycee-slide">
                    <div class="owl-slick equal-container better-height"
                        ...
                        <div class="kaycee-team style-01">
                            <div class="team-inner">
                                <div class="thumb-avatar">
                                    <a href="#" target="_self" tabindex="0">
                                        <img src="assets/images/team-img1.jpg" class="attachment-full size-full"
                                            alt="img"></a>
                        ...
                        <div class="kaycee-team style-01">
                            <div class="team-inner">
                                <div class="thumb-avatar">
                                    <a href="#" target="_self" tabindex="0">
                                        <img src="assets/images/team-img2.jpg" class="attachment-full size-full"
                                            alt="img"> </a>
                                    <div class="list-social">
                                        <a href="#" tabindex="0"><i class="az_tta-icon fa fa-facebook"></i></a>
                                        <a href="#" tabindex="0"><i class="az_tta-icon fa fa-twitter"></i></a>
                        ...
                        <div class="kaycee-team style-01">
                            <div class="team-inner">
                                <div class="thumb-avatar">
                                    <a href="#" target="_self" tabindex="0">
                                        <img src="assets/images/team-img3.jpg" class="attachment-full size-full"
                                            alt="img"> </a>
                                    <div class="list-social">
                                        <a href="#" tabindex="0"><i class="az_tta-icon fa fa-facebook"></i></a>
                                        <a href="#" tabindex="0"><i class="az_tta-icon fa fa-twitter"></i></a>
                            ...
                            <div class="team-inner">
                                <div class="thumb-avatar">
                                    <a href="#" target="_self" tabindex="-1">
                                        <img src="assets/images/team-img4.jpg" class="attachment-full size-full"
                                            alt="img"> </a>
                                    <div class="list-social">
                        ...
                        <div class="kaycee-team style-01">
                            <div class="team-inner">
                                <div class="thumb-avatar">
                                    <a href="#" target="_self" tabindex="-1">
                                        <img src="assets/images/team5-1.jpg" class="attachment-full size-full"
                                            alt="img"> </a>
                                    <div class="list-social">
                                        <a href="#" tabindex="-1"><i class="az_tta-icon fa fa-facebook"></i></a>
                                        <a href="#" tabindex="-1"><i class="az_tta-icon fa fa-twitter"></i></a>
                        ...
                        <div class="kaycee-team style-01">
                            <div class="team-inner">
                                <div class="thumb-avatar">
                                    <a href="#" target="_self" tabindex="-1">
                                        <img src="assets/images/team6.jpg" class="attachment-full size-full"
                                            alt="img"> </a>
                                    <div class="list-social">
                                        <a href="#" tabindex="-1"><i class="az_tta-icon fa fa-facebook"></i></a>
                                        <a href="#" tabindex="-1"><i class="az_tta-icon fa fa-twitter"></i></a>
                ...
                <div class="kaycee-slide">
                    <div class="owl-slick equal-container better-height"
                        ...
                        <div class="dreaming_single_image dreaming_content_element az_align_center">
                            <figure class="dreaming_wrapper az_figure">
                                <div class="az_single_image-wrapper az_box_border_grey effect bounce-in "><img
                                        src="assets/images/brand-logo-1.png" class="az_single_image-img attachment-full"
                        ...
                        <div class="dreaming_single_image dreaming_content_element az_align_center">
                            <figure class="dreaming_wrapper az_figure">
                                <div class="az_single_image-wrapper   az_box_border_grey effect bounce-in "><img
                                        src="assets/images/brand-logo-5.png" class="az_single_image-img attachment-full"
                                        alt="img" width="200" height="100">
                                </div>
                            </figure>
                        </div>
                        <div class="dreaming_single_image dreaming_content_element az_align_center">
                            <figure class="dreaming_wrapper az_figure">
                                <div class="az_single_image-wrapper  az_box_border_grey effect bounce-in "><img
                                        src="assets/images/brand-logo-4.png" class="az_single_image-img attachment-full"
                                        alt="img" width="200" height="100">
                                </div>
                            </figure>
                        </div>
                        <div class="dreaming_single_image dreaming_content_element az_align_center">
                            <figure class="dreaming_wrapper az_figure">
                                <div class="az_single_image-wrapper az_box_border_grey effect bounce-in "><img
                                        src="assets/images/brand-logo-3.png" class="az_single_image-img attachment-full"
                                        alt="img" width="200" height="100">
                                </div>
                            </figure>
                        </div>
                        <div class="dreaming_single_image dreaming_content_element az_align_center">
                            <figure class="dreaming_wrapper az_figure">
                                <div class="az_single_image-wrapper az_box_border_grey effect bounce-in "><img
                                        src="assets/images/brand-logo-2.png" class="az_single_image-img attachment-full"
                                        alt="img" width="200" height="100">
                                </div>
                            </figure>
                        </div>
            ...
            <div class="kaycee-instagram style-01">
                <div class="instagram-owl owl-slick"
                    ...
                    <div class="rows-space-0">
                        <a href="#" class="item">
                            <img class="img-responsive" src="assets/images/insta1.jpg" alt="About">
                    ...
                    <div class="rows-space-0">
                        <a href="#" class="item">
                            <img class="img-responsive" src="assets/images/insta2.jpg" alt="About">
                            <span class="instagram-info">
                                <span class="social-wrap">
                                    <span class="social-info">1 <i class="flaticon-chat"></i>
                                    </span>
                    ...
                    <div class="rows-space-0">
                        <a href="#" class="item">
                            <img class="img-responsive" src="assets/images/insta3.jpg" alt="About">
                            <span class="instagram-info">
                                <span class="social-wrap">
                                    <span class="social-info">1 <i class="flaticon-chat"></i>
                                    </span>
                    ...
                    <div class="rows-space-0">
                        <a href="#" class="item">
                            <img class="img-responsive" src="assets/images/insta4.jpg" alt="About">
                            <span class="instagram-info">
                                <span class="social-wrap">
                                    <span class="social-info">1 <i class="flaticon-chat"></i>
                                    </span>
                    ...
                    <div class="rows-space-0">
                        <a href="#" class="item">
                            <img class="img-responsive" src="assets/images/insta5.jpg" alt="About">
                            <span class="instagram-info">
                                <span class="social-wrap">
                                    <span class="social-info">1 <i class="flaticon-chat"></i>
                                    </span>
                    ...
                    <div class="rows-space-0">
                        <a href="#" class="item">
                            <img class="img-responsive" src="assets/images/insta6.jpg" alt="About">
                            <span class="instagram-info">
                                <span class="social-wrap">
                                    <span class="social-info">1 <i class="flaticon-chat"></i>
                                    </span>
                    ...
                    <div class="rows-space-0">
                        <a href="#" class="item">
                            <img class="img-responsive" src="assets/images/insta7.jpg" alt="About">
                            <span class="instagram-info">
                                <span class="social-wrap">
                                    <span class="social-info">1 <i class="flaticon-chat"></i>
                                    </span>
