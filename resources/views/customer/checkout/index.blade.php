                ...
                <div class="page-main-content">
                    <div class="kaycee">
                        ...
                        <div class="checkout-before-top">
                            <div class="kaycee-checkout-login">
                                <div class="kaycee-form-login-toggle kaycee-form-toggle">
                                    <div class="kaycee-info">
                                        Returning customer? <a href="#" class="showlogin showbtn">Click here to login</a></div>
                                </div>
                                <form class="kaycee-form kaycee-form-login login kaycee-form-show" method="post"
                                      style="display:none;">
                            ...
                            <div class="kaycee-checkout-coupon">
                                <div class="kaycee-notices-wrapper"></div>
                                <div class="kaycee-form-coupon-toggle kaycee-form-toggle">
                                    <div class="kaycee-info">
                                        Have a coupon? <a href="#" class="showcoupon showbtn">Click here to enter your code</a>
                                    </div>
                                </div>
                                <form class="checkout_coupon kaycee-form-coupon kaycee-form-show" method="post"
                                      style="display:none">
                        ...
                        <form name="checkout" method="post" class="checkout kaycee-checkout"
                              action="#" enctype="multipart/form-data"
                              novalidate="novalidate">
                            <div class="col2-set" id="customer_details">
                                <div class="col-1">
                                    <div class="kaycee-billing-fields">
                                        <h3>Billing details</h3>
                                        <div class="kaycee-billing-fields__field-wrapper">
                                            <p class="form-row form-row-first validate-required"
                                               id="billing_first_name_field" data-priority="10"><label
                                                    for="billing_first_name" class="">First name&nbsp;<abbr
                                                    class="required" title="required">*</abbr></label><span
                                                    class="kaycee-input-wrapper"><input type="text"
                                                                                             class="input-text "
                                            ...
                                            <p class="form-row form-row-wide address-field update_totals_on_change validate-required"
                                               id="billing_country_field" data-priority="40"><label
                                                ...
                                                <span class="kaycee-input-wrapper">
                                            ...
                                            <p class="form-row form-row-wide address-field validate-state"
                                               ...
                                               data-o_class="form-row form-row-wide address-field validate-state"><label
                                                    ...
                                                    class="optional">(optional)</span></label><span
                                                    class="kaycee-input-wrapper"><input type="hidden"
                                                                                             class="hidden"
                                                                                             name="billing_state"
                                            ...
                                            <p class="form-row form-row-wide validate-required validate-phone"
                                               id="billing_phone_field" data-priority="100"><label for="billing_phone"
                                                                                                   class="">Phone&nbsp;<abbr
                                                    class="required" title="required">*</abbr></label><span
                                                    class="kaycee-input-wrapper"><input type="tel"
                                                                                             class="input-text "
                                                                                             name="billing_phone"
                                                                                             id="billing_phone"
                                                                                             placeholder="" value=""
                                            ...
                                            <p class="form-row form-row-wide validate-required validate-email"
                                               id="billing_email_field" data-priority="110"><label for="billing_email"
                                                ...
                                                address&nbsp;<abbr class="required"
                                                    ...
                                                    class="kaycee-input-wrapper"><input type="email"
                                                                                             class="input-text "
                                                                                             name="billing_email"
                                                                                             id="billing_email"
                                                                                             placeholder="" value=""
                                    ...
                                    <div class="kaycee-account-fields">
                                        <p class="form-row form-row-wide create-account kaycee-validated">
                                            <label class="kaycee-form__label kaycee-form__label-for-checkbox checkbox">
                                                <input class="kaycee-form__input kaycee-form__input-checkbox input-checkbox"
                                ...
                                <div class="col-2">
                                    <div class="kaycee-shipping-fields">
                                    </div>
                                    <div class="kaycee-additional-fields">
                                        <h3>Additional information</h3>
                                        <div class="kaycee-additional-fields__field-wrapper">
                                            <p class="form-row notes" id="order_comments_field" data-priority=""><label
                                                    for="order_comments" class="">Order notes&nbsp;<span
                                                    class="optional">(optional)</span></label><span
                                                    class="kaycee-input-wrapper"><textarea name="order_comments"
                                                                                                class="input-text "
                                                                                                id="order_comments"
                            ...
                            <div id="order_review" class="kaycee-checkout-review-order">
                                <table class="shop_table kaycee-checkout-review-order-table">
                                    <thead>
                                    <tr>
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-name">
                                            T-shirt with skirt – Pink&nbsp;&nbsp; <strong class="product-quantity">×
                                            1</strong></td>
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-name">
                                            Ethereal Earrings&nbsp;&nbsp; <strong class="product-quantity">× 1</strong>
                                        </td>
                                        <td class="product-total">
                                            <span class="kaycee-Price-amount amount"><span
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-name">
                                            Riona Pearl&nbsp;&nbsp; <strong class="product-quantity">×
                                            1</strong></td>
                                        <td class="product-total">
                                            <span class="kaycee-Price-amount amount"><span
                                    ...
                                    <tr class="cart-subtotal">
                                        <th>Subtotal</th>
                                        <td><span class="kaycee-Price-amount amount"><span
                                                class="kaycee-Price-currencySymbol">$</span>418.00</span></td>
                                    </tr>
                                    <tr class="order-total">
                                        <th>Total</th>
                                        <td><strong><span class="kaycee-Price-amount amount"><span
                                ...
                                <div id="payment" class="kaycee-checkout-payment">
                                    ...
                                    <div class="form-row place-order">
                                        <noscript>
                                            ...
                                            <button type="submit" class="button alt"
                                                    name="kaycee_checkout_update_totals" value="Update totals">
                                                Update totals
                                            </button>
                                        </noscript>
                                        <div class="kaycee-terms-and-conditions-wrapper">
                                            <div class="kaycee-privacy-policy-text"><p>Your personal data will be
                                                used to process your order, support your experience throughout this
                                                website, and for other purposes described in our <a
                                                        href="#"
                                                        class="kaycee-privacy-policy-link" target="_blank">privacy
                                                    policy</a>.</p>
                                            </div>
                                        </div>
                                        <button type="submit" class="button alt" name="kaycee_checkout_place_order"
                                                id="place_order" value="Place order" data-value="Place order">Place
                                            order
                                        </button>
                                        <input type="hidden" id="kaycee-process-checkout-nonce"
                                               name="kaycee-process-checkout-nonce" value="634590c981"><input
                                            type="hidden" name="_wp_http_referer"
                                            value="/kaycee/?kaycee-ajax=update_order_review"></div>
                                </div>
                            </div>
                        </form>
                    </div>
