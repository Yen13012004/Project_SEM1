...
<div class="banner-wrapper no_background">
    <div class="banner-wrapper-inner">
        <nav class="kaycee-breadcrumb"><a href="index-2.html">Home</a><i class="fa fa-angle-right"></i><a href="#">Shop</a>
        ...
        <div class="row">
            <div class="main-content col-md-12">
                ...
                <div id="product-27"
                        ...
                        <div class="contain-left has-gallery">
                            <div class="single-left">
                                <div class="kaycee-product-gallery kaycee-product-gallery--with-images kaycee-product-gallery--columns-4 images">
                                    <a href="#" class="kaycee-product-gallery__trigger">
                            ...
                            <div class="summary entry-summary">
                                ...
                                <p class="price"><span class="kaycee-Price-amount amount"><span
                                        class="kaycee-Price-currencySymbol">$</span>146.00</span> – <span
                                        class="kaycee-Price-amount amount"><span
                                        class="kaycee-Price-currencySymbol">$</span>185.00</span></p>
                                ...
                                <form class="variations_form cart">
                                    ...
                                    <div class="single_variation_wrap">
                                        <div class="kaycee-variation single_variation"></div>
                                        <div class="kaycee-variation-add-to-cart variations_button ">
                                            <div class="quantity">
                                            ...
                                            <button type="submit"
                                                    class="single_add_to_cart_button button alt kaycee-variation-selection-needed">
                                                Add to cart
                                            </button>
                                ...
                                <div class="product_meta">
                                    ...
                                    <span class="posted_in">Categories: <a
                                            ...
                                            href="#" rel="tag">Chains</a></span>
                                    <span class="tagged_as">Tags: <a href="#"
                                                                     rel="tag">Bangles</a>, <a
                                            href="#" rel="tag">Sock</a></span>
                                </div>
                                <div class="kaycee-share-socials">
                    ...
                    <div class="kaycee-tabs kaycee-tabs-wrapper">
                        ...
                        <div class="kaycee-Tabs-panel kaycee-Tabs-panel--description panel entry-content kaycee-tab"
                        ...
                        <div class="kaycee-Tabs-panel kaycee-Tabs-panel--additional_information panel entry-content kaycee-tab"
                        ...
                        <div class="kaycee-Tabs-panel kaycee-Tabs-panel--reviews panel entry-content kaycee-tab"
                             id="tab-reviews" role="tabpanel" aria-labelledby="tab-title-reviews">
                            <div id="reviews" class="kaycee-Reviews">
                                <div id="comments">
                                    <h2 class="kaycee-Reviews-title">Reviews</h2>
                                    <p class="kaycee-noreviews">There are no reviews yet.</p>
                                </div>
                ...
                <div class="owl-slick owl-products equal-container better-height"
                    ...
                    <div class="product-item style-01 post-30 product type-product status-publish has-post-thumbnail product_cat-light product_cat-bed product_cat-specials product_tag-light product_tag-table product_tag-sock last instock featured downloadable shipping-taxable purchasable product-type-simple  ">
                        <div class="product-inner tooltip-left">
                            ...
                            <div class="product-info equal-elem">
                                <h3 class="product-name product_title">
                                    <a href="#" tabindex="0">Stylised Studs</a>
                                </h3>
                                <div class="rating-wapper nostar">
                                    <div class="star-rating"><span style="width:0%">Rated <strong
                                            class="rating">0</strong> out of 5</span></div>
                    ...
                    <div class="product-item style-01 post-22 product type-product status-publish has-post-thumbnail product_cat-table product_cat-bed product_cat-lamp product_tag-table product_tag-hat product_tag-sock first instock featured downloadable shipping-taxable purchasable product-type-simple ">
                        <div class="product-inner tooltip-left">
                            ...
                            <div class="product-info equal-elem">
                                <h3 class="product-name product_title">
                                    <a href="#" tabindex="-1">Splendid Diamond</a>
                                </h3>
                                <div class="rating-wapper nostar">
                                    <div class="star-rating"><span style="width:0%">Rated <strong
                                            class="rating">0</strong> out of 5</span></div>
            ...
            <div class="col-md-12 col-sm-12 kaycee_dreaming_upsell-product">
                <div class="block-title">
                    <h2 class="product-grid-title">
                        Upsell Products
                        <span></span>
                ...
                <div class="owl-slick owl-products equal-container better-height"
                    ...
                    <div class="product-item style-01 post-27 product type-product status-publish has-post-thumbnail product_cat-table product_cat-new-arrivals product_cat-lamp product_tag-table product_tag-sock  instock shipping-taxable purchasable product-type-variable has-default-attributes ">
                        <div class="product-inner tooltip-left">
                            ...
                            <div class="product-info equal-elem">
                                <h3 class="product-name product_title">
                                    <a href="#" tabindex="0">Dining Pendants</a>
                                </h3>
                        ...
                        <div class="product-inner tooltip-left">
                            ...
                            <div class="product-info equal-elem">
                                ...
                                <div class="rating-wapper nostar">
                                    ...
                                    <span class="review">(0)</span></div>
                                <span class="price"><span class="kaycee-Price-amount amount"><span
                                        class="kaycee-Price-currencySymbol">$</span>120.00</span></span>
                            </div>
                        </div>
                    </div>
                    <div class="product-item style-01 post-37 product type-product status-publish has-post-thumbnail product_cat-chair product_cat-bed product_tag-light product_tag-hat product_tag-sock first instock shipping-taxable purchasable product-type-simple  ">
                        <div class="product-inner tooltip-left">
                            <div class="product-thumb">
                                <a class="thumb-link kaycee-product-gallery__image"
                                   href="#"
                                   tabindex="0">
