        ...
        <div class="row">
            <div class="main-content col-md-12">
                <div class="page-main-content">
                    <form id="yith-wcwl-form" class="kaycee">
                        <!-- TITLE -->
                        <!-- WISHLIST TABLE -->
                    ...
                    <span class="nobr">
                        Stock Status                    </span>
                            ...
                            <tr id="yith-wcwl-row-29" data-row-id="29">
                                ...
                                <td class="product-thumbnail">
                                    <a href="#">
                                        <img src="assets/images/apro1113-600x778.jpg"
                                             class="attachment-kaycee_thumbnail size-kaycee_thumbnail" alt="img"
                                ...
                                <td class="product-add-to-cart">
                                    ...
                                    <a href="#"
                                       ...
                                       aria-label="Add “Ethereal Earrings” to your cart" rel="nofollow"> Add to
                                        Cart</a>
                                    <!-- Change wishlist -->
                            ...
                            <tr id="yith-wcwl-row-25" data-row-id="25">
                                ...
                                <td class="product-price">
                                    <del><span class="kaycee-Price-amount amount"><span
                                            class="kaycee-Price-currencySymbol">$</span>89.00</span></del>
                                    <ins><span class="kaycee-Price-amount amount"><span
                                            class="kaycee-Price-currencySymbol">$</span>79.00</span></ins>
                                </td>
                                <td class="product-stock-status">
                                    <span class="wishlist-in-stock">In Stock</span></td>
                                <td class="product-add-to-cart">
                                    ...
                                    <a href="#"
                                       ...
                                       aria-label="Add “Modern Platinum” to your cart" rel="nofollow"> Add to
                                        Cart</a>
                                    <!-- Change wishlist -->
                                    <!-- Remove from wishlist -->
                                </td>
                            ...
                            <tr id="yith-wcwl-row-22" data-row-id="22">
                                ...
                                <td class="product-price">
                                    <span class="kaycee-Price-amount amount"><span
                                            class="kaycee-Price-currencySymbol">$</span>98.00</span></td>
                                <td class="product-stock-status">
                                    <span class="wishlist-in-stock">In Stock</span></td>
                                <td class="product-add-to-cart">
                                    <!-- Date added -->
                                    ...
                                    <a href="#"
                                       ...
                                       aria-label="Add “Mesmerising Gold” to your cart" rel="nofollow"> Add to Cart</a>
                                    <!-- Change wishlist -->
                                    <!-- Remove from wishlist -->
                                </td>
                            </tr>
